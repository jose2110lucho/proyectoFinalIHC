<div>
            ...
            <table class="table table-bordered" style="background-color: rgb(255, 255, 220)">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-{{in_array($elemento['sigla'], $materiasYaInscritas)?'dark':'success'}}">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-success" data-container="body"
                                        data-toggle="popover" data-placement="left"
                                        data-content="Las materias que se pueden ADICIONAR de forma regular aparecen en color ROJO, en la lista de Materias Ofertadas">
                                    </button>
                                </td>
                                <td>materias que han sido adicionadas</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <div class="center" style="text-align: center; margin-top:20px;">
        <button type="button" class="btn btn-success">Adicionar materias</button>
    </div>
